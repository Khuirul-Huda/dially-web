<template>
  <div>
    ...
    <p>
      ...
      intellectual property rights related to it, still belong to Khuirul.
    </p>
    <p>
      Khuirul is committed to ensuring that the app is as useful and efficient
    ...
    <p>
      The Dially Notes app stores and processes personal data that you have
      ...
      features and it could mean that the Dially Notes app won’t work properly
      or at all.
    </p>
    <div>
      <p>
    ...
    <p>
      You should be aware that there are certain things that Khuirul will not
      ...
      provided by your mobile network provider, but Khuirul cannot take
    ...
    <p>
      Along the same lines, Khuirul cannot always take responsibility for the
      ...
      Service, Khuirul cannot accept responsibility.
    </p>
    <p>
      With respect to Khuirul’s responsibility for your use of the app, when
      ...
      available to you. Khuirul accepts no liability for any loss, direct or
    ...
    <p>
      ...
      the app. Khuirul does not promise that it will always update the app so
    ...
    <p>
      ...
      not hesitate to contact me at saya@khuirulhuda.my.id.
    </p>
    <p class="atribute">
