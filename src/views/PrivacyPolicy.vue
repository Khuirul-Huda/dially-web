<template>
  <div>
    ...
    <p>
      Khuirul built the Dially Notes app as an Ad Supported app. This SERVICE is
      provided by Khuirul at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which are accessible at Dially Notes unless
    ...
    <p>
      ...
      hesitate to contact me at saya@khuirulhuda.my.id.
    </p>
    <p class="atribute">
